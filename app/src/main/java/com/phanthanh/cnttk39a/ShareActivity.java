...
public class ShareActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Anh xa
        progressBar = (ProgressBar) findViewById(R.id.progressBarShare);
        LayoutInflater inflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
        footerView = inflater.inflate(R.layout.footer_listview, null);
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.rfshare);

        swipeRefreshLayout.setColorSchemeColors(Color.BLACK, Color.BLUE, Color.RED, Color.GREEN, Color.YELLOW);
        swipeRefreshLayout.setDistanceToTriggerSync(100);
        swipeRefreshLayout.setOnRefreshListener(this);

        lstPost = (ListView) findViewById(R.id.lstshare);
        mHandler = new ShareActivity.mHandler();
        arrayList = new ArrayList<Post>();
        adapter = new PostAdapter(ShareActivity.this, R.layout.item_list_post, arrayList);
        ...
        lstPost.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(ShareActivity.this, DetailPost.class);
    ...
    private void getData(int page){
        String url = "http://codedao.phanthanhblog.com/public/api/post/post-type?page=" + page;
            ...
            public void onResponse(JSONObject response) {
                if(response != null){
                    try {
                        ...
                        if(arr.length() == 0){
                            limitData = true;
                            Toast.makeText(ShareActivity.this, "Đã hết dữ liệu!", Toast.LENGTH_LONG).show();
                        }
